...
// Thêm ô nhập "Mã khu vực hiển thị" vào panel Tùy chỉnh cho snippet "Khóa học - Nhóm
// đối tượng" (views/snippets/trang_chu/s_trang_chu_course_group.xml) - lưu vào
// data-audience-code trên khối gốc (dataAttributeAction -> editingElement.dataset.
// audienceCode - tên kỹ thuật giữ nguyên, chỉ đổi nhãn hiển thị), đọc lại bởi
// static/src/js/course_group_snippet.js lúc tải trang để lọc đúng khóa học theo
// academic.course.audience_ids.code (Khu vực hiển thị).
